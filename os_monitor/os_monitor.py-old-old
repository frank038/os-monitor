...
class mainwindow(Gtk.Window):
    ...
    def __init__(self):
        ...
        # node name
        label0t = Gtk.Label("Network Pc Name")
        ...
        # kernel version
        label2t = Gtk.Label("Kernel Version")
        ...
        label3t = Gtk.Label("Desktop Manager")
        ...
        # installed memory
        label4t = Gtk.Label("Installed Memory")
        ...
        label6t = Gtk.Label("Root Device and type")
        ...
        if PSUTIL_V > (5,1,0):
            ...
            if battery != None:
                ...
                label12 = Gtk.Label(str(battery.percent)+"% - "+stbsec)
                label12.props.xalign = 0
                self.grid.attach(label12, 2,13,1,1)
        #
        page0_label = Gtk.Label("Summary")
        ...
        self.page1.show()
        page1_label = Gtk.Label("Memory and Network")
        ...
        #
        amlabel = Gtk.Label("Available Memory")
        ...
        #
        cmlabel = Gtk.Label("Buff/Cached Memory")
        ...
        #
        smlabel = Gtk.Label("Shared Memory")
        ...
        self.net_list = []
        #
        title_net = Gtk.Label("Network")
        title_net.props.xalign = 0
        self.page1_grid.attach(title_net, 0,12,1,1)
        # 
        snetlabel = Gtk.Label("bytes/packets sent")
        ...
        # 
        rnetlabel = Gtk.Label("bytes/packets received")
        ...
        # 
        einetlabel = Gtk.Label("errin/dropin")
        ...
        # 
        eonetlabel = Gtk.Label("errout/dropout")
        ...
        if PSUTIL_V >= (5,1,0):
            ...
            for i in range(self.n_cpu_freq):
                clabel = Gtk.Label("Cpu"+str(i+1))
                clabel.props.xalign = 0
                self.page2_grid.attach(clabel, 0,2+i,1,1)
                nflabel = Gtk.Label("Current Frequency")
        ...
        for i in range(npartitions):
            ...
            typart = Gtk.Label(tpartitions[i].fstype)
            typart.props.xalign = 0
            self.page3_grid.attach(typart, 1,3+(i*4),1,1)
            #
            tupart = Gtk.Label("Total/Used")
            ...
            ttupart = Gtk.Label(self.el_size(psutil.disk_usage(psutil.disk_partitions()[i].mountpoint).total)+" - "+self.el_size(psutil.disk_usage(psutil.disk_partitions()[i].mountpoint).used))
        ...
        if shutil.which("nvidia-smi"):
            ...
            # 
            self.pnlabel = Gtk.Label("Product Name")
            ...
            # 
            self.dvlabel = Gtk.Label("Driver Version")
            ...
            # 
            self.mmlabel = Gtk.Label("Total Memory")
            ...
            # 
            self.umlabel = Gtk.Label("Memory Used")
            ...
            # 
            self.tlabel = Gtk.Label("Temperature")
...
############ PAGE 1
    ...
    def os_infos(self):
        ...
        if home_partition:
            ...
            label9t = Gtk.Label("Home Disk Size")
